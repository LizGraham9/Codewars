...
// "boring" numbers
Solutions.CarMileage.isInteresting(3, new int[]{1337, 256});    // 0
Solutions.CarMileage.isInteresting(3236, new int[]{1337, 256}); // 0

// progress as we near an "interesting" number
Solutions.CarMileage.isInteresting(11207, new int[]{}); // 0
Solutions.CarMileage.isInteresting(11208, new int[]{}); // 0
Solutions.CarMileage.isInteresting(11209, new int[]{}); // 1
Solutions.CarMileage.isInteresting(11210, new int[]{}); // 1
Solutions.CarMileage.isInteresting(11211, new int[]{}); // 2

// nearing a provided "awesome phrase"
Solutions.CarMileage.isInteresting(1335, new int[]{1337, 256}); // 1
Solutions.CarMileage.isInteresting(1336, new int[]{1337, 256}); // 1
Solutions.CarMileage.isInteresting(1337, new int[]{1337, 256}); // 2
Error Checking
...
public class CarMileage {
  ...
  private static boolean isAlmostInteresting(int number, int[] awesomePhrases) {
    ...
    return isInterestingNumber(oneMileAhead, awesomePhrases) || isInterestingNumber(twoMilesAhead,
        awesomePhrases);
  }
  ...
  private static boolean isInterestingNumber(int number, int[] awesomePhrases) {
    ...
    return allTrailingZeroes(digitSequence)
        || allSameNumber(digitSequence)
        || incrementsSequentially(digitSequence)
        || decrementsSequentially(digitSequence)
        || isPalindrome(digitSequence)
